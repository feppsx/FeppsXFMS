...
export default function ForgotPasswordPage() {
  ...
  return (
    <AuthHero>
      <Link href="/login" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-800 mb-4">
      ...
      {sent ? (
        <div className="space-y-3">
          <div className="text-sm text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2">
            If <span className="font-medium">{email}</span> matches an account, a reset link is on the way. Check your inbox (and spam folder).
          </div>
